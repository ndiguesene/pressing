...
import com.store.pressing.repository.ProduitRepository;
            ...
            .map(
                existingProduit -> {
                    ...
                    if (produit.getCodeProduit() != null) {
                        existingProduit.setCodeProduit(produit.getCodeProduit());
                    }
                    if (produit.getTailleProduit() != null) {
                        existingProduit.setTailleProduit(produit.getTailleProduit());
                    }
