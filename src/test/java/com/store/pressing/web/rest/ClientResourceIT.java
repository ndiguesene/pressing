...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().telephone(DEFAULT_TELEPHONE);
        // Add required entity
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().telephone(UPDATED_TELEPHONE);
        // Add required entity
        User user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.telephone(UPDATED_TELEPHONE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.telephone(UPDATED_TELEPHONE);
