...
class ProduitResourceIT {
    ...
    private static final Taille DEFAULT_TAILLE_PRODUIT = Taille.S;
    private static final Taille UPDATED_TAILLE_PRODUIT = Taille.M;
    ...
    public static Produit createEntity(EntityManager em) {
        Produit produit = new Produit()
            ...
            .tailleProduit(DEFAULT_TAILLE_PRODUIT)
            .image(DEFAULT_IMAGE)
    ...
    public static Produit createUpdatedEntity(EntityManager em) {
        Produit produit = new Produit()
            ...
            .tailleProduit(UPDATED_TAILLE_PRODUIT)
            .image(UPDATED_IMAGE)
    ...
    void createProduit() throws Exception {
        ...
        assertThat(testProduit.getTailleProduit()).isEqualTo(DEFAULT_TAILLE_PRODUIT);
    ...
    @Test
    @Transactional
    void checkTailleProduitIsRequired() throws Exception {
        int databaseSizeBeforeTest = produitRepository.findAll().size();
        // set the field null
        produit.setTailleProduit(null);
    ...
    void getAllProduits() throws Exception {
        ...
        restProduitMockMvc
            ...
            .andExpect(jsonPath("$.[*].tailleProduit").value(hasItem(DEFAULT_TAILLE_PRODUIT.toString())))
    ...
    void getProduit() throws Exception {
        ...
        restProduitMockMvc
            ...
            .andExpect(jsonPath("$.tailleProduit").value(DEFAULT_TAILLE_PRODUIT.toString()))
    ...
    void putNewProduit() throws Exception {
        ...
        assertThat(testProduit.getTailleProduit()).isEqualTo(UPDATED_TAILLE_PRODUIT);
    ...
    void partialUpdateProduitWithPatch() throws Exception {
        ...
        partialUpdatedProduit.designation(UPDATED_DESIGNATION).tailleProduit(UPDATED_TAILLE_PRODUIT);
